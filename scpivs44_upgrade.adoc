...
NOTE: 僅 VMware vCenter Server 7 update 1 及更高版本支援升級至 SCV 6.2。對於 VMware vCenter Server 7 update 1 之前的版本、您應該繼續使用 SCV 4.7。在不支援的 VMware vCenter Server 版本上進行升級會造成服務中斷。
...
有關支援版本的最新資訊，請參閱link:https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp互通性對照表工具IMT （不含）"^]。

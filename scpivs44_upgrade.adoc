...
NOTE: 只有 VMware vCenter Server 7 更新版本 1 和更新版本才支援升級至 6 ． 0 號選擇控制閥、對於版本 7 更新版本 1 之前的 VMware vCenter 伺服器、您應該繼續使用 4 ． 7 號選擇控制閥。不受支援版本的VMware vCenter伺服器會中斷升級。

...
| VMware的支援工具ONTAP | SnapCenter Plug-in for VMware vSphere使用它來管理 vVol 資料儲存（VMware 虛擬磁碟區）。有關支援的版本，請參閱 https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp 互通性對照表工具"^]。 


| Amazon FSxN for NetApp ONTAP存儲 | 9.10 以上 
|===
有關受支援版本的最新信息，請參閱 https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp 互通性對照表工具"^]。
